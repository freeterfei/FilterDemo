...
import static com.visionfunny.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION_FLOAT_ARRAY;
import static com.visionfunny.gpuimage.util.VertexUtil.CUBE;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public GPUImageFilterGroup(List<GPUImageFilter> filters) {
        ...
        mGLTextureBuffer = ByteBuffer.allocateDirect(TEXTURE_NO_ROTATION_FLOAT_ARRAY.length * 4)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        mGLTextureBuffer.put(TEXTURE_NO_ROTATION_FLOAT_ARRAY).position(0);

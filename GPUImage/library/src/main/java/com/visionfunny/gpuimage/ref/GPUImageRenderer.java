...
import com.visionfunny.gpuimage.Rotation;
import com.visionfunny.gpuimage.base.OpenGlUtils;
import com.visionfunny.gpuimage.ref.GPUImage;
import com.visionfunny.gpuimage.ref.GPUImageFilter;
...
public class GPUImageRenderer implements Renderer, PreviewCallback, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onSurfaceCreated(final GL10 unused, final EGLConfig config) {
        android.util.Log.d("cff", "onSurfaceCreated");
        //GLES20.glClearColor(mBackgroundRed, mBackgroundGreen, mBackgroundBlue, 1);
        //GLES20.glDisable(GLES20.GL_DEPTH_TEST);

        if(mFilter.isUseGlTextureExternalOES()) {
            //initTex();
    ...
    public void onSurfaceChanged(final GL10 gl, final int width, final int height) {
        android.util.Log.d("cff", "onSurfaceChanged" +width +height);
        mOutputWidth = width;
...
//        }
        ...
        android.util.Log.d("cff", "mCamera =" + mCamera);
        if(mSTexture != null) {
            if(mCamera != null) {
                try {
                    android.util.Log.d("cff", "mCamera =" + mCamera);
    ...
    public synchronized void onDrawFrame(final GL10 gl) {
        android.util.Log.d("cff", "onDrawFrame");
    ...
    private void initTex() {
        android.util.Log.d("cff", "initTex");
        mGlOESTextureId = OpenGlUtils.getExternalOESTextureID();
        mSTexture = new SurfaceTexture(mGlOESTextureId);
        mSTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() {
            @Override
            public void onFrameAvailable(SurfaceTexture surfaceTexture) {
                android.util.Log.d("cff", "onFrameAvailable");
                if(mListener != null) {
    ...
    public void setUpSurfaceTexture(final Camera camera) {
        ...
        runOnDraw(new Runnable() {
            ...
            public void run() {
                ...
                /*
                try {
                    android.util.Log.d("cff", "setUpSurfaceTexture");
                    //mSTexture.setOnFrameAvailableListener(listener);
    ...
    public static int createOESTextureID() {
        ...
        GLES20.glTexParameteri(GLES11Ext.GL_TEXTURE_EXTERNAL_OES, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_NEAREST);//GL_NEAREST GL_LINEAR_MIPMAP_NEAREST
    ...
    public void initCamera(final Camera camera, SurfaceTexture.OnFrameAvailableListener listener) {
        ...
        mGlOESTextureId = createOESTextureID();
        mSTexture = new SurfaceTexture(mGlOESTextureId);
        mSTexture.setOnFrameAvailableListener(listener);
        try {
            camera.setPreviewTexture(mSTexture);
    ...
    public OnFrameAvailableListener mListener;
